...
try {
    ...
    'Controlled FTP, opportunistic TLS, FTPES, implicit FTPS, and SFTP endpoints passed password/key authentication, host-key enrollment/rotation, Unicode browse/mutation, interrupted resume, failed-transfer retry, active cancellation, Explorer export, direct/fallback FXP routing, managed TLS/SFTP/mixed relay, and cleanup checks.'
}
finally {
